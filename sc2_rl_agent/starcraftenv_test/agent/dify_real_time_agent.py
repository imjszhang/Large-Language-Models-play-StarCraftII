...
from sc2_rl_agent.starcraftenv_test.summarize.dify_test.L2_summarize import L2_summary
...
class DifyRealTimeAgent:
    ...
    def __init__(self, model_name, api_key, api_base, system_prompt, example_prompt, temperature, args,
                 ...
                 action_interval=10, chunk_window=5, action_window=20, action_mix_rate=0.5,
        ...
        self.base_save_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'log', 'dify_log')
