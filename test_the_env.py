...
# 设置StarCraft II的安装路径
os.environ["SC2PATH"] =  os.getenv('SC2PATH')

# 设置StarCraft II的地图路径
os.environ["SC2MAPS"] = os.getenv('SC2MAPS')

# 设置StarCraft II的版本
os.environ["SC2VERSION"] = os.getenv('SC2VERSION')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--agent_type', type=str, default="dify",
                        help='Agent type. Use "random" or "glm2" or "chatgpt" or "dify"')

    parser.add_argument('--LLM_model_name', type=str, default="gpt-4o-mini")
    parser.add_argument('--LLM_temperature', type=float, default=0)

    parser.add_argument('--LLM_api_key', type=str, default=DIFY_API_KEY)
    parser.add_argument('--LLM_api_base', type=str, default=DIFY_API_BASE)
